...
@section('content')
    ...
    <div class="form-container">
        ...
        <div style="background: #0f3460; border: 1px solid #991917; border-radius: 8px; padding: 15px 20px; margin-bottom: 25px;">
            ...
            <p style="color: {{ $placesDisponibles == 0 ? '#ff4444' : '#44ff44' }}; margin-top: 5px;">
                🎟️
        ...
        @if($placesDisponibles > 0)
            <form method="POST" action="/reservation">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="nbPers" min="1" max="{{ min(10, $placesDisponibles) }}" value="1" required>
                </div>
                <button type="submit" class="connexion-btn" style="width: 100%; margin-top: 10px;">CONFIRMER LA RÉSERVATION</button>
            </form>
        @else
            <p style="text-align: center; color: #ff4444; font-family: 'Orbitron', sans-serif;">Cette séance est complète.</p>
        @endif
    </div>
